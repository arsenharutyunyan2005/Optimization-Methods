...
class Segment:
    ...
    def plot_results(cls, orig_a, orig_b, hist_x, hist_y, hist_iter,
        ...
        cmap_pts = LinearSegmentedColormap.from_list("pts", ["#aa55ff", "#ff55aa", "#ffdd44"])  # brighter
        sc = ax.scatter(hist_x, hist_y,
                        c=hist_iter, cmap=cmap_pts, vmin=0, vmax=n - 1,
                        s=30, zorder=6, edgecolors="#0c0c10", linewidths=0.5)  # s=30 smaller
        ...
        legend_handles = [
            ...
            Line2D([0], [0], marker="o", color="none",
                   markerfacecolor="#aa44aa", markeredgecolor="#0c0c10",
